...
Form History is a Chrome extension to manage and restore form entries. This project allows you to quickly resubmit forms with the same data as before which is great for testing purposes.
